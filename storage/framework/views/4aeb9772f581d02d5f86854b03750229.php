...
<div class="containerr">
    ...
    <div class="colrt">
        ...
        <h1>Blog Posts</h1>
        <a href="<?php echo e(route('posts.create')); ?>" class="btn btn-secondary">Create New Post</a>
        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aiblog\blogsite\resources\views/posts/index.blade.php ENDPATH**/ ?>