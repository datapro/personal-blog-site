        ...
        <div class="col-lg-6 m-auto">
          <div class="main-heading">
            <h1>About Us</h1>
              ...
              <span class="span"><img src="{{asset('assetsmain/img/icons/span1.png')}}" alt=""> <a href="index-2.html">Home</a> <span class="arrow"><i class="fa-regular fa-angle-right"></i></span> About</span>
          </div>
        </div>
        ...
        <div class="col-12">
          <div class="marquee-wrap marquee-wrap-inner">
            <div class="marquee-text">
              ...
              <img src="{{asset('assetsmain/img/logo/slider-logo1.png')}}" alt="">
            </div>

            <div class="brand-single-box">
                <img src="{{asset('assetsmain/img/logo/slider-logo2.png')}}" alt="">
            </div>

            <div class="brand-single-box">
                <img src="{{asset('assetsmain/img/logo/slider-logo3.png')}}" alt="">
            </div>

            <div class="brand-single-box">
                <img src="{{asset('assetsmain/img/logo/slider-logo4.png')}}" alt="">
            </div>

            <div class="brand-single-box">
                <img src="{{asset('assetsmain/img/logo/slider-logo5.png')}}" alt="">
            </div>

            <div class="brand-single-box">
                <img src="{{asset('assetsmain/img/logo/slider-logo6.png')}}" alt="">
            </div>

            <div class="brand-single-box">
                <img src="{{asset('assetsmain/img/logo/slider-logo7.png')}}" alt="">
            </div>
...
<div class="about2 about-page-sec sp">
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-lg-6">
        <div class="heading1">
          <span class="span"><img src="{{asset('assetsmain/img/icons/span1.png')}}" alt=""> About Us</span>
...
<div class="solution sp bg1">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6">
        <div class="heading1">
          <span class="span"><img src="{{asset('assetsmain/img/icons/span1.png')}}" alt=""> Our Mission</span>
        ...
        <div class="solution about-solution sp">
          <div class="container">
            <div class="row align-items-center">
              <div class="col-lg-6">
                <div class="images">
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="image">
                        <img src="{{asset('assetsmain/img/about/visiton-img1.png')}}" alt="">
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                      <div class="space30"></div>
                      <div class="image">
                        <img src="{{asset('assetsmain/img/about/visiton-img2.png')}}" alt="">
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                      <div class="space30"></div>
                      <div class="image">
                        <img src="{{asset('assetsmain/img/about/visiton-img3.png')}}" alt="">
                      </div>
                    </div>
              ...
              <div class="col-lg-6">
                <div class="heading1">
                  <span class="span"><img src="{{asset('assetsmain/img/icons/span1.png')}}" alt=""> Our Vision</span>
                  ...
                  <div class="item-box">
                    <div class="icon">
                      <div class="">
                        <img src="{{asset('assetsmain/img/icons/about-solution-iocn1.png')}}" alt="">
                      </div>
                    </div>
                    <div class="">
                  ...
                  <div class="item-box">
                    <div class="icon">
                      <div class="">
                        <img src="{{asset('assetsmain/img/icons/about-solution-iocn2.png')}}" alt="">
                      </div>
                    </div>
                    <div class="">
...
<!--=====TAB START=======-->
  ...
  <div class="about-tabs sp bg1">
    <div class="container">
        <div class="row">
            <div class="col-lg-10 text-center m-auto">
                <div class="heading1">
                  <span class="span"><img src="{{asset('assetsmain/img/icons/span1.png')}}" alt=""> Our Story</span>
            ...
            <div class="col-lg-10 m-auto text-center">
                <ul class="nav nav-pills tab-header-all mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                      <button class="nav-link active" id="about-tab1-tab" data-bs-toggle="pill" data-bs-target="#about-tab1" type="button" role="tab" aria-controls="about-tab1" aria-selected="true">2017</button>
                    </li>
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="about-tab2-tab" data-bs-toggle="pill" data-bs-target="#about-tab2" type="button" role="tab" aria-controls="about-tab2" aria-selected="false">2018</button>
                    </li>
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="about-tab3-tab" data-bs-toggle="pill" data-bs-target="#about-tab3" type="button" role="tab" aria-controls="about-tab3" aria-selected="false">2019</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="about-tab4-tab" data-bs-toggle="pill" data-bs-target="#about-tab4" type="button" role="tab" aria-controls="about-tab4" aria-selected="false">2020</button>
                      </li>
                      <li class="nav-item" role="presentation">
                        <button class="nav-link" id="about-tab5-tab" data-bs-toggle="pill" data-bs-target="#about-tab5" type="button" role="tab" aria-controls="about-tab5" aria-selected="false">2021</button>
                      </li>
                      <li class="nav-item" role="presentation">
                        <button class="nav-link" id="about-tab6-tab" data-bs-toggle="pill" data-bs-target="#about-tab6" type="button" role="tab" aria-controls="about-tab6" aria-selected="false">2022</button>
                      </li>
                      <li class="nav-item" role="presentation">
                        <button class="nav-link" id="about-tab7-tab" data-bs-toggle="pill" data-bs-target="#about-tab7" type="button" role="tab" aria-controls="about-tab7" aria-selected="false">2023</button>
                      </li>
                  </ul>
            </div>
        </div>
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="about-tab1" role="tabpanel" aria-labelledby="about-tab1-tab">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                <div class="image">
                                    <img src="{{asset('assetsmain/img/about/about-tab-img.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="about-tab2" role="tabpanel" aria-labelledby="about-tab2-tab">
                      <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="tab-content-box">
                                <div class="heading1">
                    ...
                    <div class="tab-pane fade" id="about-tab4" role="tabpanel" aria-labelledby="about-tab4-tab">
                      <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="tab-content-box">
                                <div class="heading1">
                    ...
                    <div class="tab-pane fade" id="about-tab5" role="tabpanel" aria-labelledby="about-tab5-tab">
                      <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="tab-content-box">
                                <div class="heading1">
                    ...
                    <div class="tab-pane fade" id="about-tab6" role="tabpanel" aria-labelledby="about-tab6-tab">
                      <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="tab-content-box">
                                <div class="heading1">
                    ...
                    <div class="tab-pane fade" id="about-tab7" role="tabpanel" aria-labelledby="about-tab7-tab">
                      <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="tab-content-box">
                                <div class="heading1">
...
<div class="testimonial2 about-page-tes sp">
  <div class="container">
    <div class="row">
      <div class="col-lg-6 m-auto text-center">
        <div class="heading1">
          <span class="span"><img src="{{asset('assetsmain/img/icons/span1.png')}}" alt=""> Testimonials</span>
    ...
    <div class="row">
      <div class="tes2-slider owl-carousel">
        <div class="single-slider">
          <div class="icon">
            <img src="{{asset('assetsmain/img/icons/about-page-qute.png')}}" alt="">
          </div>
        ...
        <div class="team2 about-page-team sp bg1">
            <div class="container">
              <div class="row">
                <div class="col-lg-6 m-auto text-center">
                  <div class="heading1">
                    <span class="span"><img src="{{asset('assetsmain/img/icons/span1.png')}}" alt=""> Our Team</span>
...
{{-- <div class="cta">
  <div class="container">
    <div class="row align-items-center">
      ...
      {{-- <div class="col-lg-5">
        <div class="buttons">
          <a class="cta-btn1" href="service.html">Request a Consultaion <span><i class="fa-solid fa-arrow-right"></i></span></a>
          <a class="cta-btn2" href="service.html">Explore Solution <span><i class="fa-solid fa-arrow-right"></i></span></a>
        </div>
      </div>
    </div>
  </div>
